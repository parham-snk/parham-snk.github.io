 ...
 */
function __OriginkitBase_PixelCard(props) {
    ...
    const labelCfg = { text: "", color: "#ffffff", ...label }
...
export default function PixelCard(props) {
  return <__OriginkitBase_PixelCard {...(__originkitPresetProps)} {...props} />;
}
